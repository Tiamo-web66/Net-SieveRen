const page: App.I18n.Schema['translation']['page'] = {
  about: {
    title: '关于项目',
    introduction: `云渊 网盘引擎，为您的网盘整合网站带来全新体验！高效稳定，轻松应对海量数据存储与管理。操作便捷，功能强大，助您提升网站竞争力。`,
    projectInfo: {
      title: '项目信息',
      version: '版本',
  ...
  resource: {
    list: {
      ...
      form: {
        ...
        resourceClassification: 'Please select resource classification',
        resourceStatus: 'Please select resource status'
      },
    },
    classification: {
      ...
      form: {
        name: 'Please enter classification name',
        notice: 'Please enter announcement content',
        classificationStatus: 'Please select classification status'
      }
    }
  }
};
